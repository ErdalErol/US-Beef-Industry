...
All data used in the project is provided at <a href="https://github.com/ErdalErol/US-Beef-Industry" target="_blank">github repository of the project.</a> 
...
table_data %>%
  ...
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', ('Table 1: U.S. Beef Cattle Inventory')
...
table_data %>%
  ...
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', ('Table 2: U.S. Beef Cattle Inventory by State - 2021')
...
table_data %>%
  ...
  .[, Value:=Value/1000]%>%
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', ('Table 3: U.S. Beef Cattle Inventory by State: 1920-2022')
...
table_data %>%
  ...
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', ('Table 6: U.S. Beef Production')
