---
title: "Overview of the U.S. Beef Industry"
author: "Erdal Erol"
date: "`r Sys.Date()`"
output: 
  html_document:
...
* ***knitr*** and ***DT*** are used to provide customized plots, images and tables for R markdown output. 
* Animated plots and maps are produced with ***gganimate***, ***gifski*** and ***png***. 
...
## 2.2. Data Import {.tabset}

All data used in the project are provided at <a href="https://github.com/ErdalErol/US-Beef-Industry" target="_blank">github</a> repository of the project.
...
<p>&nbsp;</p>
Trade data are the amount (pound or head) of exports and imports between trade partner countries and United States. 
<p>&nbsp;</p>
**Cattle**
...
# 3. Beef Industry {.tabset}

## 3.1. Production 

### 3.1.1. Beef Cattle Inventory
<p>&nbsp;</p>
#### **National Level**
...
As we see from ***Figure 1***, beef cattle inventory has a decreasing trend since 1975 [<a href="https://www.beefmagazine.com/beef/beef-cattle-numbers-continue-decline" target="_blank">Source: An Article by Dr. Kenny Burdine (University of Kentucky) </a>]. 10, 20, and 30 years average values are relatively stable.
...
<p>&nbsp;</p>
<center>
<a href="https://unsplash.com/photos/JUeL5xDspgo" target="_blank">![Foo](images/kentucky.jpg){width=50%}<figcaption align="bottom"></a>Photo by Nik Shuliahin</a></center>
<p>&nbsp;</p>
...
The Lowe Family from Warren county has been farming in Kentucky for 219 years. Please visit <a href="https://www.kentuckycattlemensbeef.com/lowe-family.html" target="_blank">the link</a> for the details of the family's operation. 
...
<p>&nbsp;</p>
Canada and Mexico are the largest trading partner countries of U.S. in cattle and beef trade because of regional proximity and the North American Free Trade Agreement-NAFTA. Please see [<a href="https://www.fb.org/market-intel/nafta-wheres-the-beef" target="_blank">the article</a>] for the details.    
...
Bovine Spongiform Encephalopathy (BSE) is the reason for the decline in 2004 (81.7%). 53 countries banned imports of U.S. beef and beef  products. Please see [<a href="https://agecon.unl.edu/cornhusker-economics/2014/u.s.-beef-trade-disruptions#:~:text=Beef%20exports%20totaled%20%243%20billion,repairing%20the%20beef%20export%20market." target="_blank">the article in the link</a>] for details.
...
Please see <a href="https://www.mdpi.com/2071-1050/14/8/4391" target="_blank">the article in the link</a> for a detailed discussion of the price dynamics in U.S beef markets during the pandemic. 
...
## 3.4. Consumption
<p>&nbsp;</p>
We will first look over the population data and trends, and then evaluate per capita beef consumption in U.S.
...
<p>&nbsp;</p>
U.S. population had a positive trend with a decreasing growth rate during the period 1970-2021 (***Figure 24***). 1971 and 1991-1993 are the periods of the maximum growth rate (1.3%).  
...
Data shows that beef had the highest per capita consumption value until 1975 (89 pounds). It was ranked first until 2011 and chicken has ranked first since then. 
...
* Beef cow inventory in the country was 30.1 million heads by January 1, 2022.
  ...
  + Texas has been the state with the highest inventory since 1919. 
    - In 2022, the inventory was 4.5 million heads and the state had a share of 15% of the total beef cows in the country.
  + Kentucky was the 8^th^  largest state in beef cattle inventory (January 1, 2022).  
...
* International trade:
  + Cattle trade has been concentrated in 2 countries: Canada and Mexico. 
    - Export: 510 thousands cattle in 2021, almost 60% higher than 2020.
    - Import: 1,775 thousand cattle in 2021, 16% lower than 2020
    - U.S. was net importer in cattle trade for the period 1989-2021. 
...
* Consumption:
  + U.S. population had a positive trend with a decreasing growth rate during the period 1970-2021.
...
* Webpage: <a href="https://erdalerol.com/" target="_blank">erdalerol.weebly.com</a> 
