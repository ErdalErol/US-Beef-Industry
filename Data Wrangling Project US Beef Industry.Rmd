...
table_data %>%
  ...
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', htmltools::em('Table 3: U.S. Beef Production')
  ), colnames = c('Year', '1000 pounds', 'Annual Change'))%>%
...
knitr::kable(
  ...
  align = "lccrr",
  caption = "Table 4: U.S. Cattle Exports by Country - % Shares"
)
...
knitr::kable(
  ...
  col.names = c('Country', 'Share-%'),
  align = "lccrr",
  caption = "Table 5: U.S. Cattle Imports by Country - % Shares"
)
...
table_data %>%
  ...
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', htmltools::em('Table 6: U.S. Cattle Trade - 2021')
...
knitr::kable(
  ...
  col.names = c('Country', 'Share-%'),
  align = "lccrr",
  caption = "Table 7: U.S. Beef Exports by Country - % Shares"
)
...
knitr::kable(
  ...
  col.names = c('Country', 'Share-%'),
  align = "lccrr",
  caption = "Table 8: U.S. Beef Imports by Country - % Shares"
)
...
table_data %>%
  .[, country:= NULL]%>%
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', htmltools::em('Table 9: U.S. Beef Trade')
  ), colnames = c('Year', 'Export', 'Import', 'Balance', 'Position'))%>%
  formatCurrency(c('export','import', 'trade_balance'), currency = "", interval = 3, mark = ",", digits=0)
...
table_data %>%
  ...
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', htmltools::em('Table 10: U.S. Beef Prices- Cents per pound')
...
table_data %>%
  ...
  .[, date:=as.character(date)] %>%
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', htmltools::em('Table 11: U.S. Beef Price Spreads- Cents per pound')
...
table_data %>%
  ...
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', htmltools::em('Table 12: U.S. Popupation- Thousand')
...
table_data %>%
  .[order(-year)]%>% 
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', htmltools::em('Table 13: U.S. Meat Consumption - per capita- pound')
