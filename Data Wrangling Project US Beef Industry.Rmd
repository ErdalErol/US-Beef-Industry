...
knitr::kable(
  ...
  col.names = c('Country', 'Share-%'),
  align = "lccrr",
  caption = "Table 5: U.S. Cattle Imports by Country"
)
...
table_data %>%
  ...
  datatable(table_data,caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: center;', htmltools::em('Table 6: U.S. Cattle Trade')
...
knitr::kable(
  ...
  col.names = c('Country', 'Share-%'),
  align = "lccrr",
  caption = "Table 7: U.S. Beef Exports by Country"
)
...
knitr::kable(
  ...
  col.names = c('Country', 'Share-%'),
  align = "lccrr",
  caption = "Table 8: U.S. Beef Imports by Country"
)
